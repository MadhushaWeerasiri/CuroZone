...
<head>
	<meta charset="utf-8">
	<title>Assignment Schedules - CuroZone</title>
...
<div class="topbar">
	...
	<div class="side-bar">
		...
		<div class="menu">
			...
			<div class="item"><a class="sub-btn" id="active-item"><i class="fas fa-code"></i>Assignments
				...
				<div class="sub-menu">
					<a id="active-item" class="sub-item">Assignment Schedules</a>
			...
			<div class="item"><a class="sub-btn"><i class="fas fa-calendar"></i>Class Schedules
				...
				<div class="sub-menu">
					<a class="sub-item">Add Class Schedules</a>
	...
	<div class="mainframe">
		<div class="welcome">
			<h2 style="text-align: center; padding: 5px;">Assignment Schedules</h2>
			...
			<form id="form1" name="form1" method="post">
				<table class="searchtbl">
					<tbody>
						<tr>
							<td width="20%" style="text-align: right"><label for="select">Course : </label></td>
	...
	<script>
		$(document).ready(function() {
			$('#batchselect').on('change', function() {
				...
				$.ajax({
					url: "/pages/html/common/common-filter_assignment.php",
					type: "POST",
					data: 'request=' + batch_id,
					beforeSend: function() {
