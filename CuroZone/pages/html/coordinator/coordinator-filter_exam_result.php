        ...
        <table width="80%" align="center">
            ...
            if ($count) {
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    $sql1 = "SELECT * FROM exam_result_tbl WHERE student_id = '" . $student_id . "'";
            ...
            <table width="80%" align="center">
                ...
                <?php
                $sql1 = "SELECT * FROM exam_result_tbl WHERE student_id='" . $request2 . "'";
                $result1 = mysqli_query($con, $sql1);
                ...
                <table width="80%" align="center">
                    ...
                    if (mysqli_num_rows($result1)) {
                        ...
                        while ($row1 = mysqli_fetch_assoc($result1)) {
                            $sql2 = "SELECT * FROM exam_result_tbl WHERE exam_id='" . $row1['exam_id'] . "' AND student_id='" . $request2 . "'";
                            $result2 = mysqli_query($con, $sql2);
                            if (mysqli_num_rows($result2)) {
