...
?>
	...
	<head>
		<meta charset="utf-8">
		<title>Feedbacks - CuroZone</title>
	...
	<body>
		...
		<div class="side-bar">
			...
			<div class="menu">
				...
				<div class="item"><a href="coordinator-graduations.php" class="sub-item"><i class="fas fa-graduation-cap"></i>Graduations</a></div>
				...
				<div class="item"><a id="active-item"><i class="fas fa-rss"></i>Feedbacks</a></div>
			</div>
		</div>
		...
		<div class="mainframe">
			<div class="welcome">
				<h2 style="text-align: center; padding: 5px;">Feedbacks</h2>
			...
			<div class="task">
				...
				$sql = "SELECT * FROM feedback_tbl WHERE department_id = '" . $_SESSION['department_id'] . "'";
