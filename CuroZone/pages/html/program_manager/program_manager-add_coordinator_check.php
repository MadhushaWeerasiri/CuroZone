    ...
    ?>
        ...
        <head>
            ...
            <title>Add Coordinator | CuroZone</title>
        ...
        <body>
            ...
            if (!mysqli_num_rows($result)) {
                $insert_login_info = "INSERT INTO login_tbl VALUES ('" . $employee_id . "','123456','1')";
            ...
            ?>
                    <div class="div1-1">
                            ...
                            <h4>Coordinator Adding Failded.</h4>
                            <button onclick="link()">OK</button>
                        </div>
                    <?php
                } else {

                    $insert_employee = "INSERT INTO employee_tbl VALUES ('" . $employee_id . "','" . $_POST['firstnametxt'] . "','" . $_POST['lastnametxt'] . "','" . $_POST['dobtxt'] . "','" . $_POST['genderselect'] . "','" . $_POST['nictxt'] . "','" . $_POST['phonetxt'] . "','" . $_POST['emailtxt'] . "','','1','" . $_POST['departmentselect'] . "')";
                ...
                <div class="div1-1">
                    <img src="/images/error.png" alt="error image">
                    <h1 class="error">Ooops!</h1>
                    <h4>Coordinator ID allready exists.</h4>
                    <button onclick="link()">OK</button>
                </div>
            <?php
            }
            ...
            <script>
                function link() {
                    window.location.href = "program_manager-add_coordinators.php";
                }
            </script>
        </body>
