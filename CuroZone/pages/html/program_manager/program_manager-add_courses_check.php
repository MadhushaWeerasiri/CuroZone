...
?>
    ...
    <body>
        ...
        for ($w = 1; $w <= $_SESSION['modulenum']; $w++) {
            $sql = "SELECT * FROM module_tbl WHERE course_id = '" . $_POST["moduleidtxt+$w"] . "'";
        ...
        <?php
                ...
                ?>
                    <div class="div1-1">
                        <img src="/images/error.png" alt="error image">
                        <h1 class="error">Ooops!</h1>
                        <h4>Module ID:  <?php echo $_POST["moduleidtxt+$w"]; ?>  allready exists.</h4>
                        <button onclick="link()">OK</button>
                    </div>
        <?php
            }
